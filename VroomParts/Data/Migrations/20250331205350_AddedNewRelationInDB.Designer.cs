...
namespace VroomParts.Migrations
{
    ...
    [Migration("20250331205350_AddedNewRelationInDB")]
    partial class AddedNewRelationInDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VroomParts.Models.LineItems.CartProduct", b =>
                {
            ...
            modelBuilder.Entity("VroomParts.Models.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VroomParts.Models.Orders.Order", b =>
                {
                    b.HasOne("VroomParts.Models.User.ApplicationUser", null)
                        .WithMany("Orders")
